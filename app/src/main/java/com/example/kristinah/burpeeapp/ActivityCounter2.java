...
public class ActivityCounter2 extends ActionBarActivity implements SensorEventListener{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_activity_counter2, menu);
        return true;
    }
    ...
    public void senddata(View v){
            ...
            try {
                ...
                Toast.makeText(ActivityCounter2.this,
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if ((grad<110) && (grad>70) && (phase ==3) && (maxBeschl > 13)){
            ...
            player= MediaPlayer.create(ActivityCounter2.this, R.raw.pling);
            player.start();
        }
